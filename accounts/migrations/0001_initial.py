    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('Casino', 'Casino'), ('Fish', 'Fish'), ('Sports', 'Sports'), ('7/11', '7/11'), ('Slot', 'Slot')], max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag1', models.CharField(blank=True, choices=[('Recommend', 'Recommend'), ('Void Credit', 'Void Credit'), ('Promo', 'Promo'), ('Lock Credit', 'Lock Credit'), ('Free Credit', 'Free Credit'), ('Withdrawal', 'Withdrawal'), ('Borrow Credit', 'Borrow Credit')], max_length=200, null=True)),
                ('tag2', models.CharField(blank=True, choices=[('No Bonus Topup', 'No Bonus (Below Minimum Topup Amount)'), ('No Bonus', 'No Bonus'), ('Ticket', 'Ticket'), ('Rebate Bonus', 'Rebate Bonus')], max_length=200, null=True)),
                ...
                ('game_category', models.CharField(blank=True, choices=[('Casino', 'Casino'), ('Fish', 'Fish'), ('Sports', 'Sports'), ('7/11', '7/11'), ('Slot', 'Slot')], max_length=200, null=True)),
                ('restriction_category', models.CharField(blank=True, choices=[('Casino', 'Casino'), ('Fish', 'Fish'), ('Sports', 'Sports'), ('7/11', '7/11'), ('Slot', 'Slot')], max_length=200, null=True)),
                ('usage', models.CharField(blank=True, choices=[('One Time Only', 'One Time Only'), ('Daily', 'Daily'), ('Twice a Day', 'Twice a Day'), ('Yearly', 'Yearly'), ('Unlimited', 'Unlimited'), ('Thrice a Day', 'Thrice a Day'), ('Monthly', 'Monthly'), ('Weekly', 'Weekly')], max_length=200, null=True)),
